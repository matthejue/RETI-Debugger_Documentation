...
\begin{itemize}
  ...
  \item \inlinebox{read_start(state.stdout, ...)}: Reads all output from \inlinebox{state.stdout}
  \item \inlinebox{write(state.stdin, ...)}: Write all input to \inlinebox{state.stdin}
\end{itemize}
